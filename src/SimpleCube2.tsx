...
export default function BigModelViewer() {
  ...
  useEffect(() => {
    ...
    const camera = new THREE.PerspectiveCamera(50, window.innerWidth / window.innerHeight, 50, 150000);
    ...
    loader.load(
      "/city.glb",
      (gltf) => {
        // gltf.scene.colorSpace = THREE.SRGBColorSpace;
        // gltf.scene.children[0].colorSpace = THREE.SRGBColorSpace;
